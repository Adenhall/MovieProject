        ...
        <div class="container">
          <div class="row">
            ...
            <div style="color: white;">
              ...
              <h5>${result.genres.map(f => {return f.name}).join(', ')}</h5>
              </h3>
              ...
              <h5>${result.production_companies.map(x => {return x.name}).join(', ')}</h5>
              </h3>
              <h3><i class="fas fa-angle-double-right"></i> More details <a href=${result.homepage}>here!</a>
              </h3>
            </div>
          </div>
          </div>
